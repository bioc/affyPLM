...
<<weightsImageDo, results=hide, echo=FALSE, fig=FALSE, eval=FALSE>>=
...
<<weightscolorImageDo, results=hide, echo=FALSE, fig=FALSE, eval=FALSE>>=
...
<<residualImageDo, results=hide, echo=FALSE, fig=FALSE, eval=FALSE>>=
...
<<residualcolorImageDo, results=hide, echo=FALSE, fig=FALSE, eval=FALSE>>=
...
<<RLEDo, results=hide, echo=FALSE, fig=FALSE, eval=FALSE>>=
...
<<NUSEDo, results=hide, echo=FALSE, fig=FALSE, eval=FALSE>>=
